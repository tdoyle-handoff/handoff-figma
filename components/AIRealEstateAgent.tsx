...
export function AIRealEstateAgent() {
  ...
  const initializeAgentServices = () => {
    const services: AIAgentService[] = [
      ...
      },
      {
        ...
        description: 'Strategic guidance for competitive offers and negotiations',
        icon: Handshake,
        status: 'pending',
        priority: 'high',
      ...
      },
      {
        ...
        description: 'Connect with vetted lenders, inspectors, and service providers',
        icon: Users,
        status: 'available',
        priority: 'medium',
      ...
      },
      {
        ...
        description: 'AI-powered contract preparation and legal document review',
        icon: FileText,
        status: 'available',
        priority: 'medium',
    ...
    const listings: PropertyListing[] = [
      {
        ...
        description: 'Beautiful modern home in desirable Riverside Heights neighborhood. Updated kitchen with quartz countertops, open floor plan, and large backyard perfect for entertaining.',
        features: ['Updated Kitchen', 'Hardwood Floors', 'Two-Car Garage', 'Backyard', 'Modern Appliances'],
        ...
        aiRecommendation: {
          ...
          offerGuidance: 'Recommend offering 2-3% above asking price with competitive terms. Include inspection contingency but short timeframe.'
        }
      },
      {
        id: 'prop-002',
        ...
        description: 'Spacious family home with 4 bedrooms and large lot. Great for growing families, with excellent schools nearby.',
        features: ['4 Bedrooms', 'Large Lot', 'Family Room', 'Dining Room', 'Patio'],
        ...
        aiRecommendation: {
          ...
          offerGuidance: 'Consider offering 5-7% below asking price. Include contingencies for inspection and repairs.'
        }
      }
    ];
  ...
  const ServiceCard = ({ service }: { service: AIAgentService }) => {
    ...
    return (
      <Card className="hover:shadow-md transition-all duration-200 cursor-pointer h-full" onClick={() => handleServiceAction(service.id)}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className={`text-xs ${getPriorityColor(service.priority)}`}>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <Button className="w-full mt-4" variant={service.status === 'available' ? 'default' : 'outline'}>
    ...
    return (
      <Card className="hover:shadow-lg transition-all duration-200">
        ...
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-lg">{formatPrice(property.price)}</CardTitle>
              <p className="text-sm text-muted-foreground">{property.address}</p>
            </div>
            <Badge variant="outline" className={
              property.marketAnalysis.marketTrend === 'rising' ? 'border-green-200 text-green-800' :
              property.marketAnalysis.marketTrend === 'declining' ? 'border-red-200 text-red-800' :
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-3 gap-4 text-sm">
            ...
            <div className="text-center">
              <div className="font-medium">{property.squareFootage.toLocaleString()}</div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium">AI Recommendation Score</span>
              <span className="text-sm font-bold text-primary">{property.aiRecommendation.score}/100</span>
            </div>
            <Progress value={property.aiRecommendation.score} className="h-2" />
          </div>
          
          <div className="space-y-2">
            <div className="text-sm font-medium text-green-600">Why This Property:</div>
            <ul className="text-xs space-y-1">
              {property.aiRecommendation.reasons.slice(0, 2).map((reason, index) => (
          ...
          {property.aiRecommendation.concerns.length > 0 && (
            <div className="space-y-2">
              <div className="text-sm font-medium text-amber-600">Consider:</div>
              <ul className="text-xs space-y-1">
                {property.aiRecommendation.concerns.slice(0, 1).map((concern, index) => (
                  <li key={index} className="flex items-start gap-2">
          ...
          <div className="pt-2 border-t space-y-2">
            <Button className="w-full" onClick={() => ai.sendMessage(`Tell me more about ${property.address}`)}>
              <Eye className="w-4 h-4 mr-2" />
              View Details & Analysis
            </Button>
            <Button variant="outline" className="w-full" onClick={() => ai.sendMessage(`Help me prepare an offer for ${property.address}`)}>
    ...
    <div className={`space-y-6 ${isMobile ? 'p-4' : 'p-6'}`}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Your intelligent real estate partner - replacing traditional agent services with AI
          </p>
        </div>
        <Button
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Comprehensive real estate services powered by artificial intelligence
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-800">
              Your AI agent provides all traditional real estate services without commissions, 
              available 24/7 with instant responses and data-driven insights.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="properties" className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" onClick={() => ai.sendMessage('Help me refine my property search')}>
            ...
            <CardContent className="flex flex-col items-center gap-4 py-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  I can search thousands of listings and find perfect matches for you
                </p>
              </div>
              <Button onClick={() => ai.sendMessage('Show me more properties that match my criteria')}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-primary">{formatPrice(marketInsights.averagePrice)}</div>
                    <div className="text-sm text-muted-foreground">Average Price</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-green-600">${marketInsights.pricePerSqFt}</div>
                    <div className="text-sm text-muted-foreground">Price per Sq Ft</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-blue-600">{marketInsights.daysOnMarket}</div>
                    <div className="text-sm text-muted-foreground">Days on Market</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-purple-600">{marketInsights.appreciation12Month}%</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {Object.entries(marketInsights.neighborhoodInsights).map(([name, data]: [string, any]) => (
                      <div key={name} className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-medium">{name}</h4>
                          <Badge variant="outline">{data.competition} Competition</Badge>
                        </div>
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div>
                            <div className="font-medium">{formatPrice(data.avgPrice)}</div>
                            <div className="text-muted-foreground">Avg Price</div>
                          </div>
                          <div>
                            <div className="font-medium">{data.appreciation}%</div>
        ...
        <TabsContent value="network" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { type: 'Mortgage Lenders', icon: DollarSign, count: 12, rating: 4.8 },
              { type: 'Home Inspectors', icon: Shield, count: 8, rating: 4.9 },
              { type: 'Real Estate Attorneys', icon: FileText, count: 6, rating: 4.7 },
              { type: 'Insurance Agents', icon: Briefcase, count: 10, rating: 4.6 },
              { type: 'General Contractors', icon: Settings, count: 15, rating: 4.5 },
          ...
          <Alert>
            ...
            <AlertDescription>
              All professionals in our network are pre-vetted, highly rated, and offer competitive rates. 
              Your AI agent has already negotiated preferred pricing for you.
            </AlertDescription>
          </Alert>
        </TabsContent>
        ...
        <TabsContent value="documents" className="space-y-6">
          ...
          <p className="text-muted-foreground">AI-powered document preparation and review</p>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>Document Preparation</CardTitle>
                <CardDescription>Let AI prepare your real estate documents</CardDescription>
              </CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { party: 'Listing Agent', lastMessage: 'Seller accepted your offer!', time: '2 hours ago', unread: true },
                    { party: 'Loan Officer', lastMessage: 'Pre-approval documents ready', time: '1 day ago', unread: false },
                    { party: 'Home Inspector', lastMessage: 'Inspection scheduled for Friday', time: '2 days ago', unread: false }
                  ].map((convo, index) => (
                    <div key={index} className="p-3 border rounded-lg hover:bg-muted/50 cursor-pointer">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">{convo.lastMessage}</span>
                        {convo.unread && <div className="w-2 h-2 bg-primary rounded-full"></div>}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { event: 'Home Inspection', date: 'Friday, Jan 26', time: '10:00 AM' },
                    { event: 'Appraisal', date: 'Monday, Jan 29', time: '2:00 PM' },
                    { event: 'Final Walkthrough', date: 'Wednesday, Jan 31', time: '4:00 PM' }
                  ].map((event, index) => (
