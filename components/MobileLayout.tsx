...
import handoffLogo from '/favicon.svg';
import { 
  Home, 
  FileText, 
  CheckSquare, 
                    ...
                    {Object.entries(groupedNavigation).map(([category, items]) => (
                      <div key={category}>
                        <div className="mb-3">
                          ...
                          {category === 'Core' && (
                            <div className={`text-xs p-2 rounded-lg border ${categoryColors[category as keyof typeof categoryColors]} mb-3`}>
                              <div className="flex items-center gap-1 font-medium mb-1">
                                <Building className="w-3 h-3" />
                                Core Features
                              </div>
                              <div>Essential tools for your transaction</div>
                            </div>
                          )}
                        </div>
